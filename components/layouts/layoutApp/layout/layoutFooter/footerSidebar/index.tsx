...
export const FooterSidebar = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <FooterSidebarFragment>
      ...
      <div
        ref={ref}
        className='fixed left-0 top-0 z-20 w-72 bg-slate-50 pl-2 pr-0 pt-3 md:top-[4.6rem] md:z-auto md:flex md:w-full md:max-w-[16.5rem] md:flex-col md:bg-transparent md:pt-0 md:pl-2 md:pr-0'>
        <LayoutLogoFragment>
