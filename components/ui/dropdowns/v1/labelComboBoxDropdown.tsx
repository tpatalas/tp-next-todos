...
export const LabelComboBoxDropdown = ({ todo, selectedQueryLabels, container }: Props) => {
  ...
  const selectedLabelValue = useRecoilValue(selectorSelectedLabels(todo?._id));
  const selectedLabels = selectedQueryLabels ? selectedQueryLabels : selectedLabelValue;
