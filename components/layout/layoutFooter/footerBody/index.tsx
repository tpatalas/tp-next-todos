...
export const FooterBody = ({ children }: Props) => {
  ...
  const globalVerticalGradientSingleOptions = {
    gradientType: GRADIENT_TYPE['single'],
    gradientPosition: GRADIENT_POSITION['top'],
  };
  const globalVerticalGradientDoubleOptions = {
