import { DATA_FOOTER_SOCIAL } from '@collections/footer';
  ...
  return (
    <>
      <footer>
        ...
        <div className='mx-auto flex max-w-7xl flex-col items-center justify-center space-y-8 overflow-hidden px-6 pb-10 pt-16 lg:px-8'>
          <div className='mb-8'>
            <Logo />
          </div>
          <nav
            ...
            <div className='flex justify-center space-x-10'>
              {DATA_FOOTER_SOCIAL.map((item) => (
                <Link
                  ...
                  <SvgIcon options={{ path: item.path, className: 'w-6 h-6 fill-current' }} />
                </Link>
              ))}
            </div>
